<?php
        ...
        $qry="INSERT INTO `application`(`userid`,`type`,`name`, `lname`, `fname`, `mname`, `cast`,`adhar`, `income`,  `apno`, `foccupation`, `moccupation`, `iproof`, `aproof`) VALUES ('".$userid."','".$type."','".$name."','".$lname."','".$fname."','".$mname."','".$cast."','".$adhar."','".$income."','".$application_num."','".$foccupation."','".$moccupation."','".$iproof_loc."','".$aproof_loc."')";
		$rslt=$cn->query($qry);
        if($rslt){
        $subject="Application Submited Successfully";
        $body="Dear $name  you are successfully applied for Ayushman Bharath Yojan,You application number is $application_num ,You can Track your application using this number" ;
