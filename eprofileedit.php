...
<body>
    ...
    while($r1=$rslt2->fetch_assoc()) {?>
     <form method="post" action="eprofileedit.php">
                ...
                <div class="input-box">
                    ...
                    <input type="text" placeholder="Enter your username" value="<?php  echo $r1['qli'] ?>" name="qli">
                </div>
                <div class="input-box">
    ...
    //     {
            // if($pass==$cpass)
            // {
                $qry="UPDATE `emp` SET `fname`='".$fname."',`pass`='".$pass."',`qli`='".$qli."',`email`='".$email."',`cnum`='".$cnum."' WHERE empid='".$empid."'";
                $rslt=$cn->query($qry);
