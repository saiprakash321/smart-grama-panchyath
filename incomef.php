 <?php
       ...
       // $email=$_POST['email'];
        ...
        $body="Dear $name  you are successfully applied for Income Certificate,You application number is $application_num ,You can Track your application using this number" ;
