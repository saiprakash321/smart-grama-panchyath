...
<body>
    ...
    <div class="mid">
                    ...
                    while($row = mysqli_fetch_array($result))  {
                        if($row['type']=='income' && $row['status']=='passed to admin'){ ?>
                            <tbody>
                            <tr>
                                ...
                                <td><img src="<?php echo $row['iproof']; ?>" width="100px" height="100px"></td>
                                <td><img src="<?php echo $row['aproof']; ?>" width="100px" height="100px"></td>
                    ...
                    <?php 
                        if(isset($_POST['approve'])){
	                        ...
	                        $id = $_POST['id'];
                            $email = $_POST['email'];
	                        $select = "UPDATE application SET status = 'approved',comment = '".$comment."' WHERE apno = '".$id."' ";
 ...
 <br><br>
  ...
  <table>
        ...
        <?php 
             ...
             while($row = mysqli_fetch_array($result))  {
                 if($row['type']=='cast' && $row['status']=='passed to admin'){ ?>
                <tbody>
                    <tr>
                        <td scope="row"><?php echo $row['apno']; ?></td>
                        <td><?php echo $row['name']; ?></td>
 ...
 <br><br>
  ...
  <table>
        ...
        <?php 
            ...
            while($row = mysqli_fetch_array($result))  {
                if($row['type']=='birth' && $row['status']=='passed to admin'){ ?>
                <tbody>
                    <tr>
                        <td scope="row"><?php echo $row['apno']; ?></td>
                        <td><?php echo $row['name']; ?></td>
                        ...
                        <td><img src="<?php echo $row['iproof']; ?>" width="100px" height="100px"></td>
                        <td><img src="<?php echo $row['aproof']; ?>" width="100px" height="100px"></td>
                        <td><img src="<?php echo $row['hproof']; ?>" width="100px" height="100px"></td>
                        <td>
		                    <form action="adminmanage.php" method="POST">
                                <input type="textarea" name=comment >
		                        <input type="hidden" name="id" value="<?php echo $row['apno']; ?>"/>
...
<table>
      ...
      <?php 
           ...
           $result = $cn->query($qry);
           while($row = mysqli_fetch_array($result))  {
               if($row['type']=='death' && $row['status']=='passed to admin'){ ?>
              <tbody>
                  <tr>
                      <td scope="row"><?php echo $row['apno']; ?></td>
                      <td><?php echo $row['fname']; ?></td>
                      ...
                      <td><img src="<?php echo $row['iproof']; ?>" width="100px" height="100px"></td>
                      <td><img src="<?php echo $row['dproof']; ?>" width="100px" height="100px"></td>
                      <!-- <td><?php echo $row['iproof']; ?></td> -->
                      <!-- <td><?php echo $row['dproof']; ?></td> -->
...
<table>
      ...
      <?php 
          ...
          $result = $cn->query($qry);
          while($row = mysqli_fetch_array($result))  {
              if($row['type']=='water' && $row['status']=='passed to admin'){ ?>
              <tbody>
                  <tr>
                      <td scope="row"><?php echo $row['apno']; ?></td>
                      <td><?php echo $row['fname']; ?></td>
...
<table>
      ...
      <?php 
          ...
          $result = $cn->query($qry);
          while($row = mysqli_fetch_array($result))  {
              if($row['type']=='building' && $row['status']=='passed to admin'){ ?>
              <tbody>
                  <tr>
                      <td scope="row"><?php echo $row['apno']; ?></td>
                      <td><?php echo $row['name']; ?></td>
...
<table>
      ...
      <?php 
          ...
          $result = $cn->query($qry);
          while($row = mysqli_fetch_array($result))  {
              if($row['type']=='ayush' && $row['status']=='passed to admin'){ ?>
              <tbody>
                  <tr>
                  <td scope="row"><?php echo $row['apno']; ?></td>
                                <td><?php echo $row['name']; ?></td>
...
<table>
      ...
      <?php 
          ...
          $result = $cn->query($qry);
          while($row = mysqli_fetch_array($result))  {
              if($row['type']=='sandya' && $row['status']=='passed to admin'){ ?>
              <tbody>
                  <tr>
                  <td scope="row"><?php echo $row['apno']; ?></td>
                                <td><?php echo $row['name']; ?></td>
