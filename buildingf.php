<?php
        ...
        $qry="INSERT INTO `application`(`userid`,`type`,`name`, `pid`, `adhar`,  `category`,`btype`, `work`, `iproof`, `aproof`, `apno`) VALUES ('".$userid."','".$type."','".$name."','".$pid."','".$adhar."','".$category."','".$btype."','".$work."','".$iproof_loc."','".$aproof_loc."','".$application_num."')";
		$rslt=$cn->query($qry);   
        $subject="Application Submited Successfully";
        $body="Dear $name  you are successfully applied for License,You application number is $application_num ,You can Track your application using this number" ;
